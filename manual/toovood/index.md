---
title: Workflows
description: Practical Showmesh guides from preparation to live operation.
---

# Workflows

Workflows combine several features to achieve a practical result.
...
::: tip Keep a show copy
Keep the master project unchanged and save a dated copy for each performance.
This makes rollback and post-show analysis much easier.
:::
