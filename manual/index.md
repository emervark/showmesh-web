...
hero:
  ...
  tagline: Build, run, and recover cue-based media shows with confidence.
  actions:
    - theme: brand
...
This English edition documents [`emervark/Showmesh`](https://github.com/emervark/Showmesh)
`main` at commit `3e0e156` from **23 July 2026**:

| Component | Version |
|---|---|
| Showmesh beta | `0.1.0-beta.1` |
| Engine protocol | revision `23` |
| Editor UI | revision `r51` |
